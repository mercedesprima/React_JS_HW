  ...
  return (
    <header className="header center">
      ...
      <nav class="mobile-menu">
        <label class="mobile-menu__close" for="header__check">
          <svg
        ...
        <div class="mobile-menu__links-menu">
          <Link class="header__icons header__icons_mob" to="registration.html">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="29"
              height="29"
          ...
          <Link class="header__icons header__icons_mob" to="cart.html">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="32"
              height="29"
        ...
        <div class="mobile-menu__box">
          <div class="menu__item">
            <Link to="catalog.html" class="menu__title">
              MAN
            </Link>
            <ul class="menu__list">
              <li>
