  ...
  return (
    <>
      ...
      <div className="slider">
        <Link to="#" className="slider__arrow slider__arrow_left">
          <svg
            width="13"
            height="23"
            viewBox="0 0 13 23"
        ...
        <Link to="#" className="slider__arrow slider__arrow_right">
          <svg
            width="13"
            height="23"
            viewBox="0 0 13 23"
          ...
          <div className="content__sort sort">
            <details className="sort__details">
              ...
              <div className="sort__content">
                ...
                <label className="sort__label">
                  <input type="checkbox" name="color" id="grey" />
                  <span>grey</span>
                </label>
                <label className="sort__label">
                  <input type="checkbox" name="color" id="red" />
            ...
            <details className="sort__details">
              ...
              <div className="sort__content">
                <label className="sort__label">
                  <input type="checkbox" name="quantity" id={1} />
                  <span>1</span>
                </label>
                <label className="sort__label">
                  <input type="checkbox" name="quantity" id={2} />
                  <span>2</span>
                </label>
                <label className="sort__label">
                  <input type="checkbox" name="quantity" id={3} />
                  <span>3</span>
                </label>
                <label className="sort__label">
                  <input type="checkbox" name="quantity" id={4} />
                  <span>4</span>
                </label>
                <label className="sort__label">
                  <input type="checkbox" name="quantity" id={5} />
                  <span>5</span>
                </label>
              </div>
            </details>
          </div>
          <div className="button product__button">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width={27}
              height={25}
